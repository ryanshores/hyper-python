...
class FuelMixDetails:
    ...
    def get_renewable_generation(self) -> float:
        return (
            self.fuel_mix[RenewableFuel.WIND.value]
...
class FuelMix:
    ...
    def get_day(self) -> str:
        ...
        most_recent_date_idx = datetime_helper.find_index_of_most_recent_date_str(
            dayKeys
        )
    ...
    def get_time(self) -> str:
        ...
        most_recent_timestamp_idx = datetime_helper.find_index_of_most_recent_date_str(
            timestamp_keys, DATETIME_FORMAT
        )
